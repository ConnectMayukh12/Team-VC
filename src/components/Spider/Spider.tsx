        ...
        ${
          isHighlighted
            ...
            : `dark:bg-white/5 bg-white/60 dark:border-white/20 border-gray-300/60 ${
                !isHovered && "animate-spider-float"
              }`
        }
        ${
          isHovered
          ...
          {outerIcons.map((icon, i) => {
            ...
            return (
              <line
                ...
                x2={x2}
                y2={y2}
                stroke={isLineActive ? "#8B5CF6" : "#6B7280"}
                strokeWidth="1.5"
          ...
          {outerIcons.map((icon, i) => {
            ...
            return (
              <line
                ...
                x2={endX}
                y2={endY}
                stroke={isSpokeActive ? "#8B5CF6" : "#6B7280"}
                strokeWidth="1.5"
                className="transition-all duration-300 dark:stroke-gray-600"
          ...
          return (
            ...
            >
              <div className="-translate-x-1/2 -translate-y-1/2 relative">
                {/* Spotlight effect */}
                <div
                  className={`absolute -inset-5 bg-purple-500/20 dark:bg-purple-500/30 rounded-full blur-2xl transition-opacity duration-300 ${
