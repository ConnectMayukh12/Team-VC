...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-3xl lg:max-w-4xl xl:max-w-5xl rounded-3xl border shadow-xl backdrop-blur-sm ${
          theme === "dark"
...
function StepIndicator({
  ...
  const inactiveTextColor = theme === "dark" ? "#a3a3a3" : "#6b7280";
...
function StepConnector({ isComplete, theme = "dark" }: StepConnectorProps) {
